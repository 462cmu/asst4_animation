...
class Viewer {
 public:
   ...
   * Note that this does not change the user space application. // XXX kmc: is this really true?  The current implementation of Viewer::~Viewer() calls "delete application;"
   */
  ~Viewer( void );
