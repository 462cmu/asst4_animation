 ...
 * The abstract class defines a general framework for user-defined applications.
 * The viewer will forward events such as buffer resizes to
 * the application for it to respond. It will also pass events that it
 * does not know how to handle to the application so that the application can define
...
class Application {
 ...
 /**
   ...
   * the GLFW cursor events and forward the ones that matter to  the application.
  ...
  /**
   * Internal -
   * The viewer will tell the application if the screen is in HDPI mode.
   */
