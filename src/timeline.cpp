...
namespace CMU462
{
  ...
  void Timeline::draw()
  {
	...
	// Key frame time indicator color, (RED).
  ...
  Timeline::e_Element Timeline::getElement(int x, int y)
  {
	...
	// Even simpler, return the index of the button that is currently being hovered over.
  ...
  bool Timeline::isCurrentlyPlaying()
  {
	return isPlaying;
  }

  void Timeline::action_toggle_playing()
  {
	isPlaying = !isPlaying;
  }
